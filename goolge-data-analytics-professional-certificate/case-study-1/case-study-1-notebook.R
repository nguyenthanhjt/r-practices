...
![Average Ride Length by Member Type](./case-study-1_average-ride-length-by-member-type.png)
...
![Ride Count by Day of the Week](./case-study-1_ride-count-by-day-of-the-week.png)
...
![Popular Start and End Stations](./case-study-1_popular-start-n-end-stations-by-member-type.png)
